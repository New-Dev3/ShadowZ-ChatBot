...
async def kukiai(client: Client, message: Message):
  ...
  Kuki =   requests.get(f"https://kukiapi.xyz/api/apikey=KUKIkahG826GH/botname/owner/message={msg}").json()
...
async def start(_, message):
    ...
    if message.chat.type != "private":
        ...
        buttons = [[InlineKeyboardButton("Github", url="https://github.com/Team-ShadowZ/ShadowZChatBot"),
                    ]]
